...
export class OrderItemsController {
  ...
  @ApiOperation({
    ...
    description: 'Adds a product item to an order',
  })
  ...
  @ApiOperation({
    ...
    description: 'Returns all order items with order and product details',
  })
  ...
  @ApiOperation({
    ...
    description: 'Returns a single order item with order and product details',
  })
  ...
  @ApiOperation({
    ...
    description: 'Removes an order item by ID',
  })
  @ApiParam({ name: 'id', type: Number, description: 'Order Item ID' })
